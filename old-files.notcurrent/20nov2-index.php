...
<div class="scroller-wrapper">
    ...
    <div class="scroller-row">
        ...
        <!-- ================= EMPLOYER SLIDER ================= -->
        <div class="scroller-box" id="employerBox">
            <div class="scroller-title">Employers</div>

            <div class="scroller-slides" id="employerSlides">
                <div class="slide-card" onclick="alert('Employer 1 clicked!')">
                    <img src="/jobsweb/assets/sample5.jpg">
                    <div class="slide-title">Company 1</div>
                    <div class="slide-desc">Hiring updates...</div>
                </div>

                <div class="slide-card" onclick="alert('Employer 2 clicked!')">
                    <img src="/jobsweb/assets/sample6.jpg">
                    <div class="slide-title">Company 2</div>
                    <div class="slide-desc">Hiring updates...</div>
                </div>
            </div>

            <div class="dots" id="employerDots">
                <span class="dot active"></span>
                <span class="dot"></span>
            </div>
        </div>
...
autoSlide("employerSlides", "employerDots");
</script>
