...
<nav class="navbar navbar-expand-lg sticky-top" style="background:#0A4DA3;">
  <div class="container d-flex align-items-center justify-content-between">
      <a class="navbar-brand d-flex flex-row align-items-center text-white" href="#">
          <img src="assets/logo-A.png" class="brand-logo me-2" />
          <span class="fw-bold fs-3">JobsToday</span>
      </a>
      <button class="navbar-toggler text-white" type="button" data-bs-toggle="collapse" data-bs-target="#mainMenu">
          <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse" id="mainMenu">
          <ul class="navbar-nav ms-auto fw-bold" style="font-size:0.95rem;">
              ...
              <li class="nav-item"><a class="nav-link text-white" href="#">Mentor & Advisor</a></li>
              <li class="nav-item"><a class="nav-link text-white" href="#">Contact</a></li>
              <li class="nav-item"><a class="nav-link text-white" href="public/login.php">Login</a></li>
              <li class="nav-item dropdown ms-2">
                <a class="nav-link dropdown-toggle p-0" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown">
