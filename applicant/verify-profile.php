...
<div class="info-box">
  <strong>Email:</strong> <?= htmlspecialchars($verify_email) ?>
  <!-- DISABLED - Mobile verification -->
  <!-- <br><strong>Mobile:</strong> <?= htmlspecialchars($verify_mobile) ?> -->
</div>
...
<form action="skip-verification-process.php" method="POST" style="margin-top:12px">
  <button type="submit" class="btn-skip">
    Verify Later - Continue This Time
  </button>
</form>
